...
/** Строка списка книг.
 *
 * Кнопок ровно две — «Читал» и «Хочу меро»: список нужен, чтобы быстро
 * отметить, а не чтобы разбираться. Обе срабатывают на месте, повторное
 * нажатие снимает отметку. Формат встречи не спрашиваем: «хочу обсудить эту
 * книгу» — уже полноценный сигнал, а уточнить тип можно потом на карточке.
 */
